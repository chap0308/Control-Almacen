<h1 class="nombre-pagina">Productos Entrada</h1>
...
<div id="app">
    ...
    <div id="paso-2" class="seccion">
        <!--<p></p>-->
        <h2>Datos del Proveedor y Fecha</h2>
    ...
    <div class="paginacion">
    <a href="/detalleSolicitud" class="boton">Ver Detalles</a>
    </div>
</div>
...
<?php 
    $script = "
        ...
        <script src='build/js/entrada.js'></script>
    ";
?>